...
DROP TABLE IF EXISTS public.product_sellers;
...
DROP TABLE IF EXISTS public.product_color;

CREATE TABLE IF NOT EXISTS public.product_color
(
    product_id integer NOT NULL GENERATED ALWAYS AS IDENTITY,
    color_id integer NOT NULL GENERATED ALWAYS AS IDENTITY,
...
(
    product_id integer NOT NULL GENERATED ALWAYS AS IDENTITY,
    size_id integer NOT NULL GENERATED ALWAYS AS IDENTITY,
...
DROP TABLE IF EXISTS public.product_return;
...
ALTER TABLE IF EXISTS public.product_sellers
    ADD CONSTRAINT product_product_fk FOREIGN KEY (product_id)
...
ALTER TABLE IF EXISTS public.product_brand
    ADD CONSTRAINT product_brand_fk FOREIGN KEY (product_id)
    REFERENCES public.products (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS public.product_brand
    ADD CONSTRAINT brand_brand_fk FOREIGN KEY (brand_id)
...
ALTER TABLE IF EXISTS public.product_color
    ADD CONSTRAINT product_color_fk FOREIGN KEY (product_id)
    REFERENCES public.products (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS public.product_color
    ADD CONSTRAINT color_product_fk FOREIGN KEY (color_id)
...
ALTER TABLE IF EXISTS public.product_size
    ADD CONSTRAINT product_size_fk FOREIGN KEY (product_id)
    REFERENCES public.products (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS public.product_size
    ADD CONSTRAINT size_product_fk FOREIGN KEY (size_id)
